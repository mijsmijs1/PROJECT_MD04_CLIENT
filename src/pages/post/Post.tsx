        ...
        <div className='form_box'>
          <div className='content'>
            ...
            <div>
              ...
              <div>
                <span style={{ position: "unset", color: "rgb(255,99,47)" }}>Số dư của bạn hiện tại: </span><span style={{ position: "unset", color: "rgb(255,99,47)" }}>{convertToVND(userStore.data?.wallet ? userStore.data?.wallet : 0)} <ion-icon name="cash-outline"></ion-icon></span>
              </div>
              <button onClick={() => {
                if (userStore.data?.wallet < 15000) {
